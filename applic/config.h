...
#define FOSC        10000000            /* Frequentie kristal */
#define PLL_MUL     6                   /* PLL vermenigvuldiger. Waarde van 1 tot 6 */
...
#include "lpc210x.h"                    /* definieert alle registers e.d. van de LPC2106 */
#include <drivers/err.h>                /* definieert algemene foutcodes */
#include <drivers/exceptions.h>         /* bevat de nodige exception-handlers */
#ifdef DEBUG
#include <drivers/uart.h>               /* UART-initialistie en drivers */
#endif
